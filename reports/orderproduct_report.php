...
$sql = "SELECT
ORDERID, PRODUCTID, QUANTITY, 'RM ' || TO_CHAR(AMOUNT, 'FM9990.00') AS AMOUNT
FROM ORDERPRODUCT";
$stid = oci_parse($dbconn, $sql);
oci_execute($stid);

// Fetch results into $OrderProduct array
...
<head>
    <meta charset="UTF-8">
    <title>Kedai Ibu | OrderProduct Report</title>
...
<body>
    <div class="d-flex min-vh-100">
        ...
        <div class="flex-grow-1 p-4">
            <h1 class="mb-5 text-center">Order Product Report</h1>
            ...
            <?php if (count($OrderProduct) > 0): ?>
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php foreach ($OrderProduct as $OrderPro): ?>
                                <tr>
                                    <?php foreach ($OrderPro as $val): ?>
            ...
            <?php else: ?>
                <div class="alert alert-info">No Order Product data found.</div>
            <?php endif; ?>
        </div>
    </div>
