...
$sql = "SELECT ORDERID, TO_CHAR(ORDERDATETIME, 'YYYY-MM-DD HH24:MI:SS') AS ORDERDATETIME FROM ORDERS";
...
<head>
    <meta charset="UTF-8">
    <title>Kedai Ibu | Order Report</title>
...
<body>
    <div class="d-flex min-vh-100">
        ...
        <div class="flex-grow-1 p-4">
            <h1 class="mb-5 text-center">Order Report</h1>
            ...
            <?php else: ?>
                <div class="alert alert-info">No Order data found.</div>
            <?php endif; ?>
        </div>
    </div>
