...
<head>
    <meta charset="UTF-8">
    <title>Kedai Ibu | Part Time Report</title>
...
<body>
    <div class="d-flex min-vh-100">
        ...
        <div class="flex-grow-1 p-4">
            <h1 class="mb-5 text-center">List of Part Time Employees</h1>

            <?php if (count($PartTime) > 0): ?>
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php foreach ($PartTime as $part): ?>
                                <tr>
                                    <td><?= htmlspecialchars($part['EMPID']) ?></td>
                                    <td>RM <?= number_format($part['HOURLYRATE'], 2) ?></td>
                                    <td><?= htmlspecialchars($part['HOURSWORK']) ?> Hours</td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
            ...
            <?php else: ?>
                <div class="alert alert-info">No part time data found.</div>
            <?php endif; ?>
        </div>
    </div>
