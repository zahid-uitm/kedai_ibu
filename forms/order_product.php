...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    // Insert into table ORDERS first
    $orderQuery = "INSERT INTO ORDERS (ORDERID, ORDERDATETIME) VALUES ('O' || LPAD(PRODUCT_SEQ.NEXTVAL, 3, '0'), SYSDATE)";
    $stmt = oci_parse($dbconn, $orderQuery);
    ...
    if (oci_execute($stmt)) {
        ...
        foreach ($orderItems as $item) {
            $orderProductQuery = "INSERT INTO ORDER_ITEMS (ORDERID, PRODUCTID, QUANTITY, AMOUNT) VALUES (:order_id, :product_id, :quantity, :amount)";
            $stmtItem = oci_parse($dbconn, $orderProductQuery);
            ...
            oci_bind_by_name($stmtItem, ":amount", $item['price']);
